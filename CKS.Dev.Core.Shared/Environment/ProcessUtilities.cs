...
namespace CKS.Dev.VisualStudio.SharePoint.Environment
{
    ...
    class ProcessUtilities
    {
        ...
        {
            string name = service.SharePointConnection.ExecuteCommand<string, string>(CommandHelper.GetSPCommandName(DeploymentSharePointCommandIds.GetApplicationPoolName), url);
            return name;
        }
        ...
        {
            string[] names = service.SharePointConnection.ExecuteCommand<string[]>(CommandHelper.GetSPCommandName(DeploymentSharePointCommandIds.GetAllApplicationPoolNames));
            return names;
        }
